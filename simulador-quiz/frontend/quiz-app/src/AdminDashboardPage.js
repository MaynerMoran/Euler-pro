...
function AdminDashboardPage() {
    ...
    return (
        <div className="admin-dashboard-page">
            ...
            {isLoading && <p className="loading-text page-container">Cargando datos de grupos...</p>}
                            ...
                            {studentGroups.map(group => (
                                <div key={group.id} className="group-card">
                                    ...
                                    <div className="group-actions">
                                        <Link 
                                            to={`/admin/statistics/group/${group.id}`} 
                                            className="action-button view-stats-button"
                                        >
                                            Ver Estadísticas
                                        </Link>
                                    </div>
